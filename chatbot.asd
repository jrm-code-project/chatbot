...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    (:file "http-utils"         :pathname "utils/http-utils" :depends-on ("package" "vars" "logging"))
     ...
     (:file "builtin-registrations" :pathname "mcp/builtin-registrations" :depends-on ("package" "vars" "data" "json-utils" "builtin-dispatch" "mcp" "tool-arguments" "filesystem-tools" "chatbot-state-tools" "eval-grounding-tools" "git-tools" "shell-tools" "planner-minion-tools" "agentic-loops" "agentic-loop-tools"))
