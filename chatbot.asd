...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    (:file "http-utils"         :pathname "utils/http-utils" :depends-on ("package" "vars" "logging"))
     ...
     (:file "chat"               :pathname "core/chat" :depends-on ("package" "backend-registry" "vars" "data" "attachments" "conversation-compression" "chat-entry" "backend-gemini" "backend-openai" "backend-google"))
