...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    ((:file "package"            :pathname "core/package")
     ...
     (:file "agentic-directives" :pathname "core/agentic-directives" :depends-on ("package"))
     (:file "provider-config"    :pathname "core/provider-config" :depends-on ("package"))
     (:file "tool-approval"      :pathname "core/tool-approval" :depends-on ("package"))
     (:file "mcp-vars"           :pathname "mcp/mcp-vars" :depends-on ("package"))
     (:file "process-globals"    :pathname "core/process-globals" :depends-on ("package"))
     (:file "runtime-context"    :pathname "core/runtime-context" :depends-on ("package" "data" "provider-config" "tool-approval"))
     (:file "chatbot-lifecycle"  :pathname "core/chatbot-lifecycle" :depends-on ("package" "data" "provider-config" "runtime-context"))
     (:file "vars"               :pathname "core/vars" :depends-on ("package" "data" "agentic-directives" "provider-config" "tool-approval" "mcp-vars" "process-globals" "runtime-context" "chatbot-lifecycle"))
    ...
    (:file "chat-routing"       :pathname "core/chat-routing" :depends-on ("package" "vars" "data" "logging"))
    (:file "chat-entry"         :pathname "core/chat-entry" :depends-on ("package" "vars" "data" "chat-routing"))
    (:file "inbox-polling"      :pathname "core/inbox-polling" :depends-on ("package" "vars" "data" "logging"))
    (:file "http-utils"         :pathname "utils/http-utils" :depends-on ("package" "vars" "logging"))
    (:file "text-to-speech"     :pathname "utils/text-to-speech" :depends-on ("package" "vars" "logging" "http-utils" "json-utils" "inbox-polling"))
     (:file "chromadb"           :pathname "utils/chromadb" :depends-on ("package" "vars" "http-utils" "json-utils"))
     ...
     (:file "eval-grounding-tools" :pathname "mcp/eval-grounding-tools" :depends-on ("package" "vars" "json-utils" "mcp" "tool-arguments" "http-utils" "prompt-decoration"))
     ...
     (:file "agentic-loop-startup" :pathname "orchestration/agentic-loop-startup" :depends-on ("package" "vars" "data"))
     (:file "agentic-loop-state" :pathname "orchestration/agentic-loop-state" :depends-on ("package" "vars" "data" "logging" "agentic-loop-startup"))
     (:file "agentic-loop-worker" :pathname "orchestration/agentic-loop-worker" :depends-on ("package" "vars" "data" "logging" "agentic-loop-state"))
     (:file "agentic-loop-monitor" :pathname "orchestration/agentic-loop-monitor" :depends-on ("package" "vars" "data" "logging" "agentic-loop-state" "agentic-loop-worker"))
     (:file "agentic-loop-tools" :pathname "mcp/agentic-loop-tools" :depends-on ("package" "vars" "data" "mcp" "tool-arguments" "agentic-loop-worker"))
     (:file "builtin-registrations" :pathname "mcp/builtin-registrations" :depends-on ("package" "vars" "data" "json-utils" "builtin-dispatch" "mcp" "tool-arguments" "filesystem-tools" "chatbot-state-tools" "eval-grounding-tools" "git-tools" "shell-tools" "planner-minion-tools" "agentic-loop-worker" "agentic-loop-tools"))
     (:file "tool-execution"     :pathname "mcp/tool-execution" :depends-on ("package" "vars" "data" "json-utils" "builtin-tools" "builtin-dispatch" "mcp-dispatch" "tool-registry" "mcp" "tool-arguments" "filesystem-tools" "chatbot-state-tools" "eval-grounding-tools" "git-tools" "shell-tools" "planner-minion-tools" "agentic-loop-worker" "agentic-loop-tools" "builtin-registrations" "chromadb"))
     ...
     (:file "conversation-constructors" :pathname "core/conversation-constructors" :depends-on ("package" "vars" "data" "logging"))
     (:file "conversation-persistence"  :pathname "core/conversation-persistence"  :depends-on ("package" "vars" "data" "logging" "checkpoint-schema" "personas" "mcp" "request-history" "conversation-constructors" "text-to-speech"))
     (:file "conversation-compression"  :pathname "core/conversation-compression"  :depends-on ("package" "vars" "data" "logging" "conversation-constructors" "conversation-persistence"))
     (:file "turn-runner"        :pathname "backends/turn-runner" :depends-on ("package" "vars" "data" "request-history" "tool-execution"))
     (:file "google-caching"     :pathname "backends/google-caching" :depends-on ("package" "vars" "data" "logging" "http-utils" "google-payloads" "conversation-compression"))
     ...
     (:file "chat"               :pathname "core/chat" :depends-on ("package" "backend-registry" "vars" "data" "attachments" "conversation-compression" "chat-entry" "inbox-polling" "backend-gemini" "backend-openai" "backend-google"))
     ...
     (:file "sandbox-personas"   :pathname "orchestration/sandbox-personas" :depends-on ("package" "data" "conversation-compression" "prompt-decoration" "text-utils" "chat"))
...
(defsystem "chatbot/tests"
  ...
  ((:module "tests"
    ...
    ((:file "tests")
     ...
     (:file "tests-chromadb"     :depends-on ("tests"))
     (:file "tests-tts"          :depends-on ("tests"))))))
