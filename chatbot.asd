...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    (:file "http-utils"         :pathname "utils/http-utils" :depends-on ("package" "vars" "logging"))
     ...
     (:file "conversation-persistence"  :pathname "core/conversation-persistence"  :depends-on ("package" "vars" "data" "logging" "checkpoint-schema" "personas" "mcp" "request-history" "conversation-constructors"))
