...
(defsystem "chatbot"
  ...
  ((:module "infrastructure"
    ...
    ((:file "package")
     ...
     (:file "round-robin"     :depends-on ("package" "data" "attachments" "prompt-decoration" "text-utils" "chat"))
     (:file "sandbox-personas" :depends-on ("package" "data" "conversations" "prompt-decoration" "text-utils" "chat"))
