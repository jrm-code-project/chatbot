...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    ((:file "package"            :pathname "core/package")
     ...
     (:file "tool-execution"     :pathname "mcp/tool-execution" :depends-on ("package" "vars" "data" "json-utils" "builtin-tools" "mcp-dispatch" "tool-registry" "mcp" "tool-arguments" "filesystem-tools" "chatbot-state-tools" "eval-grounding-tools" "git-tools" "planner-minion-tools" "agentic-loops" "agentic-loop-tools"))
