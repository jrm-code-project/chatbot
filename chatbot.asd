...
(defsystem "chatbot"
  ...
  ((:module "src"
    ...
    ((:file "package"            :pathname "core/package")
     ...
     (:file "mcp-startup"        :pathname "mcp/mcp-startup" :depends-on ("package" "vars" "data" "mcp-lifecycle"))
      (:file "agentic-loops"      :pathname "orchestration/agentic-loops" :depends-on ("package" "vars" "data" "logging"))
     (:file "tool-execution"     :pathname "mcp/tool-execution" :depends-on ("package" "vars" "data" "json-utils" "builtin-tools" "tool-registry" "mcp" "agentic-loops"))
     ...
     (:file "backend-gemini"     :pathname "backends/backend-gemini" :depends-on ("package" "vars" "data" "logging" "http-utils" "text-utils" "payloads" "gemini-payloads" "mcp" "tool-execution"))
     (:file "backend-openai"     :pathname "backends/backend-openai" :depends-on ("package" "vars" "data" "http-utils" "text-utils" "payloads" "openai-payloads" "mcp" "tool-execution"))
     (:file "backend-google"     :pathname "backends/backend-google" :depends-on ("package" "vars" "data" "logging" "http-utils" "payloads" "google-payloads" "mcp" "tool-execution"))
